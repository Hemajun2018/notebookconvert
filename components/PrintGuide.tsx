...
export default function PrintGuide() {
  return (
    <div className="mt-6 rounded-xl border border-accent-200 bg-accent-50 p-5">
      <h3 className="font-semibold text-accent-700 text-sm mb-3 flex items-center gap-2">
        <svg
      ...
      <ol className="space-y-2 text-sm text-ink-700">
        <li className="flex items-start gap-2">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-accent-500 text-white text-xs flex items-center justify-center font-bold mt-0.5">
            1
          </span>
        ...
        <li className="flex items-start gap-2">
          ...
          <span>
            Optional: enable <strong>Background graphics</strong> in &ldquo;More settings&rdquo; to
        ...
        <li className="flex items-start gap-2">
          ...
          <span>
            Click <strong>Save</strong> or <strong>Print</strong> to download your PDF.
          </span>
        </li>
      </ol>
